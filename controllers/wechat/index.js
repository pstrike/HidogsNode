...
var apiUser = new WechatAPI(configUser.appid, configUser.secret, function (callback) {
    // 传入一个获取全局token的方法
    fs.readFile('/home/ftp/hd_prod/hidogs/web/wxhcweb/apitoken/access_token.txt', 'utf8', function (err, txt) {
    ...
    //fs.writeFile(wechatconfig.apidir+'/'+'access_token.txt', JSON.stringify(token), callback);
    fs.writeFile('/home/ftp/hd_prod/hidogs/web/wxhcweb/apitoken/access_token.txt', JSON.stringify(token), callback);
});
