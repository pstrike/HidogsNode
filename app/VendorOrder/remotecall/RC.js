...
var RemoteCall = {
    getOrderList: function (vendorId) {
        var promise = new Promise(function(resolve, reject){
            var url = APIUtils.makeUrl("/orders?projection=status,product,booked_time,vendor,user,price,order_id,created_time,isOnSite&filter=vendor.vendor_id,"+vendorId);
